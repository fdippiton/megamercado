...
class gen_factura():
    ...
    def gen_prod(self):
        ...
        self.t4=tk.Label(self._frame, text= "Código cliente:", font=("Roboto Mono",10), bg="white").place(x=208, y=130)
        self.t5=tk.Label(self._frame, text= "Código producto:", font=("Roboto Mono",10), bg="white").place(x=200, y=165)
        self.t6=tk.Label(self._frame, text= "", font=("Roboto Mono",12), bg="white")
        self.t6.place(x=600, y=165)
        self.t7=tk.Label(self._frame, text= "Cantidad:", font=("Roboto Mono",10), bg="white").place(x=258, y=200)
        self.t8=tk.Label(self._frame, text= "", font=("Roboto Mono",12), bg="white")
        self.t8.place(x=600, y=200)
        self.t9=tk.Label(self._frame, text= "Producto:", font=("Roboto Mono",10), bg="white").place(x=505, y=165)
        self.t10=tk.Label(self._frame, text= "Precio:", font=("Roboto Mono",10), bg="white").place(x=520, y=200)
        self.t11=tk.Label(self._frame, text= "Nombre:", font=("Roboto Mono",10), bg="white").place(x=520, y=133)
