...
class rpt_ventas():
    ...
    def rpt_ventas_title(self):
        ...
        self.lis_prod_title = tk.Label(self._frame, text='Reportes de ventas', font=('Roboto Mono', 13), bg='white')
    ...
    def show_rpt_ventas(self):
        self.tree_Table = ttk.Treeview(self._frame, height=20, columns=('#1', '#2', '#3', '#4', '#5'), show='headings')
        ...
        self.tree_Table.heading('#4', text='Precio de venta', anchor='center')
        self.tree_Table.column('#4', minwidth=0, width=190, stretch='NO')
        self.tree_Table.heading('#5', text='Ventas', anchor='center')
